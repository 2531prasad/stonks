    ...
    >
      {sortedWindows.map((win) => {
        ...
        return (
          ...
          >
            <Card 
              className="h-full w-full flex flex-col bg-card/40 backdrop-blur-sm border-border/20 text-card-foreground rounded-lg overflow-hidden shadow-2xl shadow-black/40"
